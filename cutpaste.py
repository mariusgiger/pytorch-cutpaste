...
class CutPasteNormal(CutPaste):
    ...
    def __call__(self, img):
        ...
        ratio_area = random.uniform(
            self.area_ratio[0], self.area_ratio[1]) * w * h
        ...
        box = [from_location_w, from_location_h,
               from_location_w + cut_w, from_location_h + cut_h]
        patch = img.crop(box)
        ...
        insert_box = [to_location_w, to_location_h,
                      to_location_w + cut_w, to_location_h + cut_h]
        augmented = img.copy()
